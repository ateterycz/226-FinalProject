...
<div class="container">
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="models\amggt.jpg" style="width:100%" onclick="currentSlide(1)" alt="AMG-GT">
    </div>
    <div class="column">
      <img class="demo cursor" src="models\maybach.jpg" style="width:100%" onclick="currentSlide(2)" alt="MAYBACH">
    </div>
    <div class="column">
